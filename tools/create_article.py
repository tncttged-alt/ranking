...
<body data-root="../../" data-page-index="{page_index}"{comments_attr}>
    {create_menu('../../')}
    <main class="main">
        <article class="article">
            ...
            <section id="comments" class="comments"><h2>コメント</h2><div id="commentsList"></div>
